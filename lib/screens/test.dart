                                    ...
                                    return GestureDetector(
                                        onTap: () {
                                          setState(() {
                                            center = position;
                                            selectedcenter =
                                                centers[position].name;
                                            print(centers[position]);
                                          });
                                        },
                                        child: Card(
                                          child: ListTile(
                                            trailing: center == position
                                                ? const Icon(Icons.check)
                                                : null,
                                            leading: Icon(
                      ...
                      Expanded(
                          child: GridView.builder(
                              ...
                              itemBuilder: (context, index) => InkWell(
                                    ...
                                    child: Card(
                                      color: TIME_SLOT.elementAt(index) ==
                                              selectedTimeSlot
                                          ? Colors.white54
                                          : Colors.white,
                                      child: GridTile(
                                        ...
                                        header: TIME_SLOT.elementAt(index) ==
                                                selectedTimeSlot
                                            ? Icon(Icons.check)
                                            : null,
                                      ),
                ...
                itemBuilder: (context, index) {
                  return GestureDetector(
                      ...
                      child: Card(
                        child: ListTile(
                          trailing:
                              saved == index ? const Icon(Icons.check) : null,
                          leading: Icon(
                            Icons.bloodtype_outlined,
                            color: Colors.red,
                          ),
